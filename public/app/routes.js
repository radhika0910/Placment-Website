var app = angular
  ...
  .config(function ($routeProvider, $locationProvider) {
    $routeProvider
      ...
      //Filtering Routes
      .when("/filter", {
        templateUrl: "/app/views/filter/filterStudent.html",
        authenticated: true,
      ...
      .when("/interview-experiences", {
        templateUrl:
          "/app/views/interview-experiences/interview-experiences.html",
        authenticated: true,
        controller: "interviewCtrl",
        controllerAs: "interview",
      })
      ...
      .when("/pending-experiences", {
        templateUrl:
          "/app/views/interview-experiences/pending-experiences.html",
        authenticated: true,
     ...
     .when("/about", {
      ...
      .when("/placement-management", {
        templateUrl:
          "/app/views/management/placements/placement-management.html",
        authenticated: true,
        permission: ["admin", "spc", "faculty-coordinator"],
      ...
      .when("/email-groups-management", {
        templateUrl:
          "/app/views/management/email-groups/email-groups-management.html",
        authenticated: true,
        permission: ["admin", "spc", "faculty-coordinator"],
...
app.run([
  ...
  "$location",
  "student",
  function ($rootScope, auth, $location, student) {
        ...
        if (next.$$route.authenticated === true) {
          if (!auth.isLoggedIn()) {
            ...
            student.getPermission().then(function (data) {
              if (
                next.$$route.permission.indexOf(data.data.permission) === -1
              ) {
                event.preventDefault();
                $location.path("/");
              }
